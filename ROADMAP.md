...
- **GH-132 · feat(skills): formal /review-xyz code review skill & multi-model harness** 🚧 **active 2026-08-21** — first-class deterministic code review skill (/review-xyz) and Python engine (utils/py/review_xyz.py) providing throwaway-worktree isolated multi-model code review (Command Code -> Qwen 3.8-Max, GLM-5.3; Aider/OpenRouter; Codex; Agy), structured finding extraction ([Blocker]/[Should]/[Nit]/[Pass]), and automated GitHub PR/issue commenting. rated 80/70/85/40. → [GH-132-REVIEW-XYZ-SKILL.md](PROJECT/2-WORKING/GH-132-REVIEW-XYZ-SKILL.md) · [#132](https://github.com/HiQS-Suite/XYZ-forge/issues/132)
