...
3. Use this exact tick binary (run it from any directory): /Users/noelsaw/Documents/GH Repos/xyz-3-agents-swarm/bin/tick
   - /Users/noelsaw/Documents/GH Repos/xyz-3-agents-swarm/bin/tick claim MARATHON-GH391-EMIT-MARATHON-YAML-TURN --agent codex --paths "marathon-system/nightwatch-wave-2-2026-08-10--gh391-emit-marathon-yaml/RELAY.md,utils/py/marathon_yaml_emit.py,test/gh391-emit-marathon-yaml.sh,validate.sh"
   - /Users/noelsaw/Documents/GH Repos/xyz-3-agents-swarm/bin/tick ping MARATHON-GH391-EMIT-MARATHON-YAML-TURN --agent codex
   - /Users/noelsaw/Documents/GH Repos/xyz-3-agents-swarm/bin/tick release MARATHON-GH391-EMIT-MARATHON-YAML-TURN --agent codex --to agy
...
2. If changes needed: add `**Verdict:** Changes requested`, update the `NEXT:` line to exactly `NEXT: codex (Builder)`, then: /Users/noelsaw/Documents/GH Repos/xyz-3-agents-swarm/bin/tick release MARATHON-GH391-EMIT-MARATHON-YAML-TURN --agent agy --to codex
3. If satisfied: add `**Verdict:** Approved`, set `STATUS: Approved`, then: /Users/noelsaw/Documents/GH Repos/xyz-3-agents-swarm/bin/tick done MARATHON-GH391-EMIT-MARATHON-YAML-TURN --agent agy
