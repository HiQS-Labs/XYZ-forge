...
>>>>>>> a019b6c3 (chore(gh556): regenerate dashboard after ledger resolution (staleness guard satisfaction))
<!-- GENERATED by utils/roadmap-dashboard.sh — DO NOT EDIT; edit the ledger through releases CLI. -->

# ROADMAP Dashboard

Read-only derived view of the roadmap ledger (releases.db).
...
| GH-556 · skills-army-hq: post-GH-536 hardening — source re-anchor, ignore defaults, mode-stable digests | — | [GH-556-SKILLS-POSTRELOC-HARDENING.md](PROJECT/1-INBOX/GH-556-SKILLS-POSTRELOC-HARDENING.md) · [#556](https://github.com/HiQS-Labs/XYZ-forge/issues/556) |
...
| GH-533 · Relay scaffold verdict vocabulary contradicts validate-relay-block | — | [GH-533-RELAY-VERDICT-VOCABULARY.md](PROJECT/2-WORKING/GH-533-RELAY-VERDICT-VOCABULARY.md) · [#533](https://github.com/HiQS-Labs/XYZ-forge/issues/533) |
| GH-529 · Relay attestation rejects scaffold-required marker placement | — | [GH-529-RELAY-MARKER-ATTESTATION.md](PROJECT/2-WORKING/GH-529-RELAY-MARKER-ATTESTATION.md) · [#529](https://github.com/HiQS-Labs/XYZ-forge/issues/529) |
| GH-554 · tick mutating verbs silently accept unknown flags | — | [GH-554-TICK-UNKNOWN-FLAGS.md](PROJECT/2-WORKING/GH-554-TICK-UNKNOWN-FLAGS.md) · [#554](https://github.com/HiQS-Labs/XYZ-forge/issues/554) |
| GH-555 · merge-cleanup B1 leaves releases.db.bak after resolution | — | [GH-555-MERGE-CLEANUP-B1-BAK.md](PROJECT/2-WORKING/GH-555-MERGE-CLEANUP-B1-BAK.md) · [#555](https://github.com/HiQS-Labs/XYZ-forge/issues/555) |

## Completed

Summary: 102 items | Tally: 🟢 0 · 🟡 0 · ⏸️ 0 · ⛔ 0 · ✅ 68 · 🔮 0 · 🔲 0
...
| GH-536 · relocate: Deployed Skills moves INTO the live Git Pulse Sync checkout (supersedes #508 verdict) | ✅ | [GH-536-DEPLOYED-SKILLS-RELOCATION.md](PROJECT/3-COMPLETED/GH-536-DEPLOYED-SKILLS-RELOCATION.md) · [#536](https://github.com/HiQS-Labs/XYZ-forge/issues/536) |
...
| GH-549 · Work-state event stream + concurrent connectors: GitHub Kanban first, HQ and Flightdeck next | ✅ | [GH-549-WORK-STATE-EVENT-STREAM.md](PROJECT/3-COMPLETED/GH-549-WORK-STATE-EVENT-STREAM.md) · [#549](https://github.com/HiQS-Labs/XYZ-forge/issues/549) |
