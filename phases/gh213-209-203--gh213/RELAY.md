...
1. Implement the brief by creating/editing the artifact file(s): skills/relay-xyz/find-harness.sh,test/find-harness.sh
...
3. Use this exact tick binary (run it from any directory): /Users/noelsaw/Documents/GH Repos/xyz-3-agents-swarm/bin/tick
   - /Users/noelsaw/Documents/GH Repos/xyz-3-agents-swarm/bin/tick claim MARATHON-GH213-TURN --agent codex --paths "phases/gh213-209-203--gh213/RELAY.md,skills/relay-xyz/find-harness.sh,test/find-harness.sh"
   - /Users/noelsaw/Documents/GH Repos/xyz-3-agents-swarm/bin/tick ping MARATHON-GH213-TURN --agent codex
   - /Users/noelsaw/Documents/GH Repos/xyz-3-agents-swarm/bin/tick release MARATHON-GH213-TURN --agent codex --to agy
4. Edit ONLY these paths: phases/gh213-209-203--gh213/RELAY.md and skills/relay-xyz/find-harness.sh,test/find-harness.sh. Do NOT run git. Do NOT touch any other file — the harness commits for you.

---

▶ TAKE YOUR TURN (agy — REVIEWER role)

You are the REVIEWER for this phase. Read the latest builder block above AND review the artifact file(s) on disk: skills/relay-xyz/find-harness.sh,test/find-harness.sh.
1. Append a review block: `### Round N · Reviewer · agy` followed by your assessment.
2. If changes needed: add `**Verdict:** Changes requested` then: /Users/noelsaw/Documents/GH Repos/xyz-3-agents-swarm/bin/tick release MARATHON-GH213-TURN --agent agy --to codex
