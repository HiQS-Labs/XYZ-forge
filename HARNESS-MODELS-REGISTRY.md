...
| Command Code | `qwen/qwen3.7-flash` | Cloud | Advisory review | **B** | One documented non-interactive SOP review (~23 s); do not infer autonomous-builder qualification. | [GH-18 capture](PROJECT/1-INBOX/GH-18-COMMANDCODE-EVAL.md) |
...
| Command Code | Node.js / Langbase | Subscription and/or credits | `cmd -p` | Current evidence is pending PR integration. |
...
| **2026-08-16** | Command Code + Qwen 3.7-Flash | Regraded **A → B** | One fast non-interactive review is documented; no three-run autonomous-builder evidence exists. |
