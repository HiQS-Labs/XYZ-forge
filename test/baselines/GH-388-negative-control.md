...
test/gh388-run-log-durability.sh: line 36: ~/Documents/GH Repos/xyz-3-agents-swarm/relay-automation/durable-log-lib.sh: No such file or directory
...
Traceback (most recent call last):
  File "<string>", line 3, in <module>
    print(rtl.non_durable_reason('~/Documents/GH Repos/xyz-3-agents-swarm/relay-system/logs/a.log'))
          ^^^^^^^^^^^^^^^^^^^^^^
AttributeError: module 'rtl' has no attribute 'non_durable_reason'
test/gh388-run-log-durability.sh: line 43: xyz_non_durable_reason: command not found
Traceback (most recent call last):
...
cp: ~/Documents/GH Repos/xyz-3-agents-swarm/relay-automation/durable-log-lib.sh: No such file or directory
