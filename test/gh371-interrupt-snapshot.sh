...
cp "$ROOT_REPO/utils/py/marathon_drive.py" "$ROOT_REPO/utils/py/relay_drive.py" "$ROOT_REPO/utils/py/relay_attest.py" "$ROOT_REPO/utils/py/rtl.py" "$ROOT_REPO/utils/py/harness_paths.py" "$HARNESS/utils/py/"
