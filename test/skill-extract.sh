...
relay-automation/relay-drive.sh relay-automation/relay-turn-lib.sh relay-automation/new-relay.sh \
relay-automation/codex-turn.sh relay-automation/agy-turn.sh relay-automation/README.md \
...
[ "$miss" = 0 ] && pass "all 14 packaged files extracted" || fail "package is missing files"
