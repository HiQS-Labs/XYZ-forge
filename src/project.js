...
// foldWithMeta returns both the projected task map and the deterministic list of
// fenced (rejected) mutation events. `fold` is the back-compat thin wrapper that
// returns just the task map.
