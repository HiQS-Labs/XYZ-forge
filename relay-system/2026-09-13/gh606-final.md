...
- Definition of Done: The approved plan is PROJECT/2-WORKING/GH-606-END-OF-WEEK-SKILL.md. Review the entire skill, matching each acceptance scenario to actual instructions. Answer:
  ...
  4. Can the workflow reach a verified board result without publishing unmerged task-clone metadata or bypassing canonical writers? Flag command/semantic errors against current code.
