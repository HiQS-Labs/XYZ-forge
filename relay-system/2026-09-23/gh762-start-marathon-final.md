# RELAY · GH-762 start marathon final review
<!--
...
6. **Commit only the relay file** (`relay(gh762-start-marathon-final): <role> r<N>`); no push. **Stop** and report one line.
...
## Setup
- Artifact under review: **agy-review-packet-r2.md** (embedded below — read it here).
- Reviewer: agy   ·   Producer: claude-a
- Started: 2026-09-23

### Artifact — agy-review-packet-r2.md
````
Review GH-762 current committed branch after the dangling-link fix. Read the full skills/2-daily/start-marathon/SKILL.md, installer, pre-marathon command, nudge hook, and focused tests. Check primary/secondary routing, governance, canonical parking, bounded recovery, and truth of the full-plan dry-run. Review only: do not run tests or create files. Prior Agy finding: a dangling legacy link was preserved; fix is now committed and focused GH-678 suite passed.
diff --git a/.claude/commands/pre-marathon.md b/.claude/commands/pre-marathon.md
index da3abe4a..4c028140 100644
--- a/.claude/commands/pre-marathon.md
+++ b/.claude/commands/pre-marathon.md
@@ -3,20 +3,18 @@
...
+++ b/relay-automation/hooks/skill-nudge.sh
@@ -5,8 +5,8 @@
...
+        skills.append("start-marathon")
     ...
     closeout_detail = any(
diff --git a/skills/2-daily/start-marathon/SKILL.md b/skills/2-daily/start-marathon/SKILL.md
new file mode 100644
index 00000000..c23d9c3d
--- /dev/null
+++ b/skills/2-daily/start-marathon/SKILL.md
@@ -0,0 +1,399 @@
+---
+name: start-marathon
+description: >
...
+original.
diff --git a/skills/2-daily/start-marathon/install.sh b/skills/2-daily/start-marathon/install.sh
new file mode 100755
index 00000000..40e3c113
--- /dev/null
+++ b/skills/2-daily/start-marathon/install.sh
@@ -0,0 +1,54 @@
+#!/usr/bin/env bash
...
+fi
diff --git a/test/gh678-installer-live-links.sh b/test/gh678-installer-live-links.sh
index c1ca52fb..f02d5d07 100755
--- a/test/gh678-installer-live-links.sh
+++ b/test/gh678-installer-live-links.sh
...
index 4dc9efd0..9e26e7c4 100755
