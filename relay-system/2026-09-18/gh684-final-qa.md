# RELAY · GH-684/GH-686 final QA — implementation, tests and evidence
<!--
...
6. **Commit only the relay file** (`relay(gh684-final-qa): <role> r<N>`); no push. **Stop** and report one line.
