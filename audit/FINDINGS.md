...
**Harness under test:** `github.com/HiQS-Suite/XYZ-forge` @ `C:\Users\Askyla\Senior_dev\XYZ-forge`
**Reproduction:** every finding below is reproduced by `audit/repro.sh` (one bash file, no network, no API keys).
