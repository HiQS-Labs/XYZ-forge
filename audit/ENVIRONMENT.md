...
> recalled. Every value below was captured by `audit/repro-containment.sh` into
> `audit/logs/env-stamp.log` and rendered to `audit/screens/env-stamp.png`.
>
...
| Headless browser | Google Chrome (used for screenshot capture and local mermaid rendering) |
