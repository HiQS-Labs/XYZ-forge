...
TESTS=(
  ...
  "gh396-find-harness-roots.sh"     # GH-396 Phase 0 (find-harness two-roots contract: #395 ×5 topologies, #394 warn-under-override + runnable remedy, --quiet) — arrives RED by design
  "gh393-deepseek-readiness.sh"     # GH-396 Phase 0 / #393 (RELAY_HAS_DEEPSEEK parity with deepseek-turn.py's own binary rule + API key) — arrives RED by design
)
