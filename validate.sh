...
TESTS=(
  ...
  "gh182-healer-facade-safety.sh"       # #182 (self_healer CLI safety: mandatory sandbox containment, regression gate, 900s timeout, restoration)
  "gh201-bounded-autonomy-governor.sh"   # #201 (Bounded Autonomy, Governor Control & Advisory Blast Radius Sensor)
