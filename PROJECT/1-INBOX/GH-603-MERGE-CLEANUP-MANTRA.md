...
title: "feat(skills): add 5-point discipline mantra and overall goal to merge-cleanup, start-task, and workhorse skills"
...
goal: >
  ...
  anchors at the top of skills/merge-cleanup/SKILL.md, skills/start-task/SKILL.md, and
  skills/workhorse/SKILL.md (matching debug-mantra) to enforce re-anchoring across multi-turn agent conversations.
roadmap_exempt: true
---

# GH-603 — workflow discipline mantras for merge-cleanup, start-task, and workhorse

Add verbatim 5-point discipline mantra recital blocks and Overall Goal anchors to `skills/merge-cleanup/SKILL.md`, `skills/start-task/SKILL.md`, and `skills/workhorse/SKILL.md` to ensure agents reciting the skill at the start of execution re-anchor context across multi-turn sessions.
