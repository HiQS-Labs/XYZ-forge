...
|---|---|
| Phase 4 root dogfood complete (2026-08-28): queue compiled from the Releases ledger (0.9.0 dialed-in GH-107 + GH-105; 0.7.4 Linux RC excluded per operator; GH-222 excluded — artifact overlaps the executor overlay), agy builder + codex reviewer, REAL turns, PRs #283/#284 merged into development, both issues closed, lifecycle reconciled, cold-start + replay boundaries exercised. Evidence: `relay-system/2026-08-28/gh280-phase4-dogfood/`. | Phase 4 fully closed (vendored `.xyz` half landed 2026-08-29 via the GH-222 dogfood — `relay-system/2026-08-29/gh222-vendored-dogfood/`, PRs #311/#312); all named follow-up fixes landed (#296 F1-F3, #301 B1/B2/B5, #312 recurrence fixes); Phase 5 flip + QA landed 2026-08-29 (#318/#317/#319 + the GH-314 default-path run, PR #320); legacy removal pending its post-window commit. |
...
| 4 — Dogfood root and vendored runs | Complete | Root: PRs #283/#284 (both MERGED into development), issues #107/#105 CLOSED, evidence under `relay-system/2026-08-28/gh280-phase4-dogfood/`. Vendored: GH-222 dogfood 2026-08-29 — approved end-to-end run from a foreign cwd with the harness under `.xyz/`, evidence under `relay-system/2026-08-29/gh222-vendored-dogfood/` (PRs #311/#312). |
| 5 — Default flip + retire duplication | Flip + window + docs landed 2026-08-29 (PRs #318/#317/#319); removal manifest audited (A=0/B=3/C=36) | Default-path QA run 2026-08-29: GH-314 through the full chain — queue → intake contract → preflight READY → agy build + codex review (Approved) → gate green → PR #320 → verified `jog land` + wave_reconcile. 12m43s, one attempt; intake earned four correct refusals first (no silent guessing). Vendored half: default-path run 2026-08-29 — approved end-to-end from a foreign cwd via the vendored `.xyz` drive, evidence under `relay-system/2026-08-29/gh280-phase5-vendored-default/`. Legacy removal = its own commit one release cycle post-flip per the #319 manifest (time-gated by design, not work-gated: the manifest is staged). |
