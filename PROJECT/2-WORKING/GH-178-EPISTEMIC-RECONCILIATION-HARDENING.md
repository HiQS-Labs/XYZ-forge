...
status: Active (2-WORKING) — B1, B2, A2 shipped, A1 inventoried (2026-07-08)
created: 2026-07-08
updated: 2026-07-08
owner: noel
...
- [x] **B1** carries a new regression test (`test/test-agy-isolation.sh`) that mocks agy outputting the real `$ROOT` path, asserting that both `consult.sh` and `agy-turn.sh` catch it, write the failure message, and exit 5.
- [ ] Remaining items (A1, A4) each need their own regression test as they land
