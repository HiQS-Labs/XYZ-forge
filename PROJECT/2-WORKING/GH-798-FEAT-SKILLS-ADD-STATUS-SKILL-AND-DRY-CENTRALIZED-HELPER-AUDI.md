...
gh_issue: 798
source: https://github.com/HiQS-Labs/XYZ-forge/issues/798
doc_type: bugfix
complexity: 2
risk: 2
effort: 2
...
goal: >
  Express hotfix (GH-267 lane): feat(skills): add status skill and DRY/centralized-helper audit in review-code
---

# GH-798 — feat(skills): add status skill and DRY/centralized-helper audit in review-code

## Status

| What was just completed | What's next |
|---|---|
| Fix qualified for /express; regression suite test/gh798-status-skill.sh registered (green asserted at landing, Step 7; receipt in TESTS-RESULTS/) | Reconcile promotes this doc when issue #798 closes |
...
- Landed via the /express fast lane (GH-267): the fix, its suite, this doc, and the
  ...
  run's receipts. Operator-supplied summary: feat: add status skill and DRY/centralized-helper audit in review-code
