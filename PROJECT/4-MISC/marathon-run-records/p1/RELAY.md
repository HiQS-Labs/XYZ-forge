...
- Mode: project-doc
- Sources: ~/Documents/GH Repos/xyz-3-agents-swarm/PROJECT/2-WORKING/GH-491-GATE-ONLY-REFIRE-DISCOVERABILITY.md 
- Target root: ~/Documents/GH Repos/xyz-3-agents-swarm (development @ 72a821933)
...
*Inlined verbatim from `~/Documents/GH Repos/xyz-3-agents-swarm/PROJECT/2-WORKING/GH-491-GATE-ONLY-REFIRE-DISCOVERABILITY.md` (its `## Acceptance` section, 5 criterion(a)). Continuation lines included; if a
...
3. Use this exact tick binary (run it from any directory): ~/Documents/GH Repos/xyz-3-agents-swarm/bin/tick
   - ~/Documents/GH Repos/xyz-3-agents-swarm/bin/tick claim MARATHON-P1-TURN --agent agy --paths "marathon-system/p1/RELAY.md,utils/py/marathon_drive.py,test/gh491-gate-only-refire.sh,test/gh268-relay-cue-and-target-checks.sh,test/gh307-gate-env-scrub.sh,test/gh322-runlog-python-lane.sh,test/gh342-sentinel-debug-log-python.sh,test/gh376-relay-drive-lock-parity.sh,test/gh385-retry-token-satisfied.sh,test/gh390-gate-guard.sh,test/gh399-packet-acceptance-continuation.sh,test/gh407-gate-ran-attribution.sh,test/gh438-acceptance-recheck.sh,test/gh438-removal-is-progress.sh,test/gh441-gate-env-contract.sh,test/gh457-gate-tiers.sh,test/gh467-index-only-lane-blocked.sh,test/gh520-default-reviewer-stub.sh,test/baselines/GH-402-negative-control.md,test/baselines/GH-514-negative-control.md,test/_setup.sh"
   - ~/Documents/GH Repos/xyz-3-agents-swarm/bin/tick ping MARATHON-P1-TURN --agent agy
   - ~/Documents/GH Repos/xyz-3-agents-swarm/bin/tick release MARATHON-P1-TURN --agent agy --to codex
4. Edit ONLY these paths: marathon-system/p1/RELAY.md and utils/py/marathon_drive.py,test/gh491-gate-only-refire.sh,test/gh268-relay-cue-and-target-checks.sh,test/gh307-gate-env-scrub.sh,test/gh322-runlog-python-lane.sh,test/gh342-sentinel-debug-log-python.sh,test/gh376-relay-drive-lock-parity.sh,test/gh385-retry-token-satisfied.sh,test/gh390-gate-guard.sh,test/gh399-packet-acceptance-continuation.sh,test/gh407-gate-ran-attribution.sh,test/gh438-acceptance-recheck.sh,test/gh438-removal-is-progress.sh,test/gh441-gate-env-contract.sh,test/gh457-gate-tiers.sh,test/gh467-index-only-lane-blocked.sh,test/gh520-default-reviewer-stub.sh,test/baselines/GH-402-negative-control.md,test/baselines/GH-514-negative-control.md,test/_setup.sh. Do NOT run git. Do NOT touch any other file — the harness commits for you.
...
2. If changes needed: add `**Verdict:** Changes requested`, update the `NEXT:` line to exactly `NEXT: agy (Builder)`, then: ~/Documents/GH Repos/xyz-3-agents-swarm/bin/tick release MARATHON-P1-TURN --agent codex --to agy
3. If satisfied: add `**Verdict:** Approved`, set `STATUS: Approved`, then: ~/Documents/GH Repos/xyz-3-agents-swarm/bin/tick done MARATHON-P1-TURN --agent codex
