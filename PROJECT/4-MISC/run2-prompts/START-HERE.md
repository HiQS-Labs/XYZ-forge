...
You are one of two AI coding agents in a coordination experiment, working in a
clone of the `experiment/coordination-layer` branch. First, identify yourself,
then read and execute your own instruction file — read the whole file before
you begin.
