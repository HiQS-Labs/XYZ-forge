...
```bash
"$(git rev-parse --show-toplevel)/skills/agent-chorus/scripts/agent_chorus.py" invite \
  --id 123456 \
  --agent 3 \
...
```bash
"$(git rev-parse --show-toplevel)/skills/agent-chorus/scripts/agent_chorus.py" verify-citations \
  --id 123456
```
