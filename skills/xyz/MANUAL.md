# xyz — the full manual (multi-agent coordination via `tick`)

> **This is the exhaustive manual of the `xyz` skill.** The concise entry point
> is `SKILL.md` in this directory (triggers, scope, rails, routing). Everything
> here is the long form: the self-extracting runtime installer (§4), the full
> embedded test suite (§4b), and the complete use-case workflows (§5–§10).
>
