#!/usr/bin/env python3
"""Convenience runner for review_xyz within skills/2-daily/review-xyz."""
import os
import sys
...
XYZ_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(SKILL_DIR)))  # skills/<tier>/<name> (GH-744)
