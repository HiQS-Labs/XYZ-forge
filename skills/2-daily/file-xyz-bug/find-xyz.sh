...
#   2. this script's own real location             — …/<repo>/skills/2-daily/file-xyz-bug → <repo>
...
# 2. relative to this script (…/<repo>/skills/2-daily/file-xyz-bug → <repo>). This is the primary
