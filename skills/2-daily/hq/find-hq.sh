...
#   3. this script's own real location — …/<repo>/skills/2-daily/hq → <repo> (the cross-repo case)
#
...
SELF_DIR="$(cd -P "$(dirname "$_src")" >/dev/null 2>&1 && pwd)"   # …/skills/2-daily/hq
...
# 3. relative to this script (…/<repo>/skills/2-daily/hq → <repo>) — the cross-repo case: the skill is
