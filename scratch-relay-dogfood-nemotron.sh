...
DIFF_FILE="/tmp/gh-118-119-120-113-114-full-diff.txt"

RELAY_OUT="$(relay-automation/new-relay.sh --title "Reverse-dogfood: Nemotron Ultra 3 reviews GH-118/119/120+113/114" --reviewer aider --artifact-file "$DIFF_FILE")"
...
export AIDER_FLAGS="--read .relay-artifacts/gh-118-119-120-113-114-full-diff.txt --edit-format diff"
